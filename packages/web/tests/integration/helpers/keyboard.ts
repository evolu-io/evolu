...
// This two workarounds are needed for on MacOS:
// https://github.com/GoogleChrome/puppeteer/issues/1313
// Copy pasted from:
// https://github.com/WordPress/gutenberg/blob/master/packages/e2e-test-utils/src/press-key-with-modifier.js
...
/**
 * Performs a key press with modifier normalized to platform-specific modifier.
...
export async function pressKeyWithModifier(
  // From console.log(overWrittenModifiers), no 'meta' for some reason.
  // alt is good enough for quick navigation.
  // Not sure what primary and secondary exactly is. It does not work arrow keys:
